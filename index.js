...
const nokotan = document.getElementById("img-section");
nokotan.onclick = function () {
  let audio = new Audio("./audios/nun.mp3");
  audio.play();
}
...
letterSection.onclick = function () {
  letterPopup.style.display = "block";
}
const letterSectionMobile = document.getElementById("letter-section-mobile");
letterSectionMobile.onclick = function () {
  letterPopup.style.display = "block";
}
